...
const initialEmployees = [
  { id: 1, name: "John Smith", position: "Frontend Developer", department: "Engineering", email: "john@example.com", joiningDate: "2020-05-15", status: "Active", image: "https://i.pravatar.cc/150?img=1" },
  ...
  { id: 3, name: "Michael Chen", position: "Product Manager", department: "Product", email: "michael@example.com", joiningDate: "2021-02-10", status: "Active", image: "https://i.pravatar.cc/150?img=9" },
  { id: 4, name: "Sarah Williams", position: "UX Designer", department: "Design", email: "sarah@example.com", joiningDate: "2020-09-30", status: "On Leave", image: "https://i.pravatar.cc/150?img=10" },
  { id: 5, name: "David Rodriguez", position: "Backend Developer", department: "Engineering", email: "david@example.com", joiningDate: "2022-03-05", status: "Active", image: "https://i.pravatar.cc/150?img=12" }
];
